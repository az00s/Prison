    ...
    public class Repository
    {
        ...
        public Repository()
        {
            _list = new List<Blurb> {
                ...
                new Blurb{ BlurbID=2,BlurbHeader="Tesla Model 3",BlurbContent="Жги резину, а не бензин!  самый доступный электромобиль от Tesla",Image=GetByteArrFromImage("~/Images/Tesla.jpg") },
                ...
                new Blurb{ BlurbID=8,BlurbHeader="Toyota RAV4 EV",BlurbContent="Если бы мы делали девушек, то они бы никогда не ломались.",Image=GetByteArrFromImage("~/Images/Toyota.jpg")},
                ...
                new Blurb{ BlurbID=10,BlurbHeader="Geely Emgrand EV300",BlurbContent="Попробуйте новое электрическое желе из Китая!",Image=GetByteArrFromImage("~/Images/Geely.jpg")}
            };
        }
